...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/genfanh/swag/testdata/global_override/types.Application":  "string",
		"github.com/genfanh/swag/testdata/global_override/types.Application2": "github.com/genfanh/swag/testdata/global_override/othertypes.Application",
		"github.com/genfanh/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
