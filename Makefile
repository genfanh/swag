...
BINARY_NAME:=swag
PACKAGES:=$(shell $(GOLIST) github.com/genfanh/swag github.com/genfanh/swag/cmd/swag github.com/genfanh/swag/gen github.com/genfanh/swag/format)
