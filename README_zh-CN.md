...
[点击此处](https://github.com/genfanh/swag/tree/master/example/celler)查看示例源代码。
...
此处查看格式化结果 [here](https://github.com/genfanh/swag/tree/master/example/celler).
...
**示例** [`celler/main.go`](https://github.com/genfanh/swag/blob/master/example/celler/main.go)
...
Example [celler/controller](https://github.com/genfanh/swag/tree/master/example/celler/controller)
